...
const projects = [
  {
    ...
    description: 'A modern, responsive portfolio website built with Next.js, TypeScript, and Tailwind CSS. Features dark mode, animations, and interactive components.',
  ...
  },
  {
    ...
    description: 'A full-stack task management application with real-time updates, user authentication, and a responsive design.',
  ...
  {
    title: 'CLI Tool',
    description: 'A command-line interface tool built with Node.js for automating common development tasks and improving workflow efficiency.',
